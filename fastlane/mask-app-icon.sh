#!/bin/sh
# This overlays App version, build number, branch and latest commit on AppIcon. This is pretty useful for QAs when they are testing the build as they can refer to Build number when raising issues.
# You need to install imagemagick and ghostscript for this.
